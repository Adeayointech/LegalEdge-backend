...
const PLANS: Record<PlanKey, { label: string; price: number; duration: string; perMonth: string; badge: string | null }> = {
  ...
  quarterly: { label: 'Quarterly', price: 58500,  duration: '3 months', perMonth: '₦19,500 / mo', badge: 'Save ₦1,500' },
  biannual:  { label: '6 Months',  price: 116000, duration: '6 months', perMonth: '₦19,333 / mo', badge: 'Save ₦4,000' },
  annual:    { label: 'Yearly',    price: 230000, duration: 'year',     perMonth: '₦19,167 / mo', badge: 'Save ₦10,000' },
};
