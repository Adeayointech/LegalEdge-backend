...
import { createSupportTicket, getUserSupportTickets, getAllSupportTickets, updateSupportTicketStatus, getAllFirms, addUserReply } from '../controllers/support.controller';
...
router.post('/:ticketId/reply', authenticate, addUserReply);
